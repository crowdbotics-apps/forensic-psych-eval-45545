"""
Django settings for forensic_psych_eval_45545 project.
...
ROOT_URLCONF = 'forensic_psych_eval_45545.urls'
...
WSGI_APPLICATION = 'forensic_psych_eval_45545.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "forensic_psych_eval_45545 API",
    "DESCRIPTION": "API documentation for forensic_psych_eval_45545 App",
    "VERSION": "v1",
}
